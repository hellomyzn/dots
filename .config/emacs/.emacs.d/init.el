...
(setq org-agenda-files
      '("~/projects/footprints/emacs/org/agendas/tasks.org"
        "~/projects/footprints/emacs/org/agendas/habits.org"))
(setq org-todo-files
      '("~/projects/footprints/emacs/org/agendas/tasks.org"))
(defun my-clocktable-files ()
  (list "~/projects/footprints/emacs/org/agendas/tasks.org"
	"~/projects/footprints/emacs/org/agendas/habits.org"
	"~/projects/footprints/emacs/org/agendas/journal.org"))

(setq org-refile-targets
      '(("~/projects/footprints/emacs/org/agendas/journal.org" :maxlevel . 3)
        ("~/projects/footprints/emacs/org/agendas/habits.org" :maxlevel . 1)))
(setq org-archive-files "~/projects/footprints/emacs/org/agendas/journal.org")

;; Registers for file shortcuts
(set-register ?t (cons 'file "~/projects/footprints/emacs/org/agendas/tasks.org"))
(set-register ?h (cons 'file "~/projects/footprints/emacs/org/agendas/habits.org"))
(set-register ?j (cons 'file "~/projects/footprints/emacs/org/agendas/journal.org"))
...
(setq org-capture-templates
      `(
            ("t" "Task" entry
            (file+olp "~/projects/footprints/emacs/org/agendas/tasks.org" "Tasks")
            "* TODO %? \nSCHEDULED: %^t DEADLINE: %^t\nCREATED_AT: %U\n  %^{Effort}p"
            :empty-lines 1)

            ("s" "Study" entry
            (file+olp "~/projects/footprints/emacs/org/agendas/tasks.org" "Studies")
            "* TODO %? :study:\nSCHEDULED: %^t DEADLINE: %^t\nCREATED_AT: %U\n  %^{Effort}p\n** Type\n** Url\n** Properties\n** Homework\n** Notes"
            :empty-lines 1)

            ("w" "Work" entry
            (file+olp "~/projects/footprints/emacs/org/agendas/tasks.org" "Works")
            "* TODO %? :work:\nSCHEDULED: %^t DEADLINE: %^t\nCREATED_AT: %U\n  %^{Effort}p"
            :empty-lines 1)
...
** Journal\n\n"
            ...
            ("h" "Habit Entries")
                  ("hd" "Daily" entry
                  (file+olp "~/projects/footprints/emacs/org/agendas/habits.org" "Daily")
                  "* TODO %? :daily:\nSCHEDULED: %^{Scheduled}t\n:PROPERTIES:\n:STYLE: habit\n:END:\nCREATED_AT: %U\n %^{Effort}p"
                  :empty-lines 1)

                  ("hw" "Weekly" entry
                  (file+olp "~/projects/footprints/emacs/org/agendas/habits.org" "Weekly")
                  "* TODO %? :weekly:\nSCHEDULED: %^{Scheduled}t\n:PROPERTIES:\n:STYLE: habit\n:END:\nCREATED_AT: %U\n %^{Effort}p"
                  :empty-lines 1)

                  ("hm" "Monthly" entry
                  (file+olp "~/projects/footprints/emacs/org/agendas/habits.org" "Monthly")
                  "* TODO %? :monthly:\nSCHEDULED: %^{Scheduled}t\n:PROPERTIES:\n:STYLE: habit\n:END:\nCREATED_AT: %U\n %^{Effort}p"
                  :empty-lines 1)))
